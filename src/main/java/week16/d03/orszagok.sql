...
-- Adatbázis struktúra mentése a orszagok.
CREATE DATABASE IF NOT EXISTS `orszagok` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `orszagok`;

-- Struktúra mentése tábla orszagok. orszagok
CREATE TABLE IF NOT EXISTS `orszagok` (
  `orszag` varchar(27) DEFAULT NULL,
  `fovaros` varchar(19) DEFAULT NULL,
  `foldr_hely` varchar(37) DEFAULT NULL,
  `terulet` decimal(11,2) DEFAULT NULL,
  `allamforma` varchar(30) DEFAULT NULL,
  `nepesseg` int(8) DEFAULT NULL,
  `nep_fovaros` int(8) DEFAULT NULL,
  `autojel` varchar(3) DEFAULT NULL,
  `country` varchar(31) DEFAULT NULL,
  `capital` varchar(19) DEFAULT NULL,
  `penznem` varchar(20) DEFAULT NULL,
  `penzjel` varchar(3) DEFAULT NULL,
  `valtopenz` varchar(18) DEFAULT NULL,
  `telefon` smallint(3) DEFAULT NULL,
  `GDP` int(5) DEFAULT NULL,
  `KAT` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Tábla adatainak mentése orszagok.orszagok: ~194 rows (hozzávetőleg)
